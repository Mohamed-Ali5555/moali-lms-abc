        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 col-md-6">
                    <form action="{{ route('theme.password.email') }}" class="global-form login-form mt-25" method="POST">
                        @csrf
                        <h4 class="g-title">{{ get_phrase('Forgot Password') }}</h4>
                        <p class="description" style="margin-bottom: 30px;">{{ get_phrase('Submit your account email address.') }} </p>
