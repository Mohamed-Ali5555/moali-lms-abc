...
@section('content')@push('title', get_phrase('Reset Password'))
@push('meta')@endpush
@push('css')
@endpush
@section('content')
    <!------------------- Login Area Start  ------>
    <section class="login-area"style=" margin-top: 150px;">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 col-md-6">
                    <form action="{{ route('theme.password.store') }}" method="post">
                        @csrf
                        ...
                        <div class="form-group">
                            <label for="email" class="form-label"  style="margin-bottom: 16px;">{{ get_phrase('Email') }}</label>
                        ...
                        <div class="form-group">
                            <label for="" class="form-label" style="margin-bottom: 16px;">{{ get_phrase('Password') }}</label>
                        ...
                        <div class="form-group">
                            <label for="password_confirmation" class="form-label"  style="margin-bottom: 16px;">{{ get_phrase('Confirm Password') }}</label>
                        ...
                        <a href="{{route('theme.login')}}" class="eBtn gradient w-100 mt-5 text-center">{{ get_phrase('Back to login page') }}</a>
                    </form>
                </div>
            </div>
        </div>
