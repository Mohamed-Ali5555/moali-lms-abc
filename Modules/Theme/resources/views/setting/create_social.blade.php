        ...
        <div class="col-md-12">
            <div class="ol-card p-4">
                ...
                <div class="ol-card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form class="required-form" action="{{ route('admin.theme.social.store') }}"
                            ...
                            {{-- instructor name --}}
                            <div class="fpb-7 mb-3">
                                <label class="form-label ol-form-label" for="url">{{ get_phrase('url') }}<span class="required">*</span></label>
                                <input type="text" name = "url" id = "url" class="form-control ol-form-control" value="{{ old('url') }}" required>
                            </div>
