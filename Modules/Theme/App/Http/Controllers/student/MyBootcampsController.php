...
class MyBootcampsController extends Controller
{
    ...
    public function index()
    {
        $page_data['my_bootcamps'] = BootcampPurchase::join('bootcamps', 'bootcamp_purchases.bootcamp_id', 'bootcamps.id')
            ...
            return view('theme::student.my_bootcamps.index',$page_data);
    ...
    public function show($slug)
    {
        ...
        return view('theme::student.my_bootcamps.details',$page_data);
    ...
    public function invoice($id)
    {
        ...
        $invoice = BootcampPurchase::where('bootcamp_id',$id)->with('bootcamp')->first();
        //  return($invoice);
        if (! $invoice) {
            Session::flash('error', get_phrase('Data not found.'));
            return redirect()->back();
        ...
        return view('theme::student.my_bootcamps.invoice',$page_data);
