...
<form action="{{ route('admin.course.quiz.update', $id) }}" method="post">@csrf
    ...
    <div class="fpb7 mb-3">
        ...
        <select class="form-control ol-form-control ol-select2" id="type" name="type" disabled>
            <option value="1" {{ $quiz->type == 1 ? 'selected' : '' }}>Quiz</option>
            <option value="2" {{ $quiz->type == 2 ? 'selected' : '' }}>Assignment</option>
        </select>
    ...
    <div class="row mb-3">
        <div class="fpb7 col-sm-6 mb-3">
            ...
            <input class="form-control ol-form-control" type="datetime-local" name="start_time" value="{{ $quiz->start_time }}">
        </div>
        <div class="fpb7 col-sm-6 mb-3">
            <label class="form-label ol-form-label" for="title">
                {{ get_phrase('End Time') }}
            ...
            <input class="form-control ol-form-control" type="datetime-local" name="end_time" value="{{ $quiz->end_time }}">
        </div>
    </div>
