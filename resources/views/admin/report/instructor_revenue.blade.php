    ...
    <div class="ol-card p-4">
        <div class="ol-card-body">
            ...
            <div class="row mb-3 mt-3 row-gap-3">
                ...
                @if (has_permission('admin.instructor.revenue.export'))
                        ...
                        @if ($reports->count() > 0)
                            <div class="custom-dropdown">
                                ...
                                <ul class="dropdown-list">
                                    <li>
                                        <a class="dropdown-item" href="#" onclick="downloadPDF('.print-table', 'instructor-revenue')"><i class="fi-rr-file-pdf"></i> {{ get_phrase('PDF') }}</a>
                                    </li>
                                    <li>
                ...
                @endif
                @if (has_permission('admin.instructor.revenue.search'))
                                    ...
                                    @foreach ($reports as $key => $report)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="dAdmin_profile d-flex align-items-center">
                                                    <div class="dAdmin_profile_name">
                                                     ...
                                                     @endforeach                                                        <p class="mt-1 fs-12px">{{ get_phrase('Enrolled: ') }}
                                            ...
                                            <td class="print-d-none">
                                                @if (has_permission('admin.instructor_revenue.delete'))
                                                    <div class="adminTable-action">
                                                        <button type="button" class="btn ol-btn-light ol-icon-btn" data-bs-toggle="tooltip" title="{{ get_phrase('Delete') }}" onclick="confirmModal('{{ route('admin.instructor_revenue.delete', $report->id) }}')">
