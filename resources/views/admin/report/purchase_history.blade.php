        ...
        <div class="ol-card-body my-3 py-4 px-20px">
            <div class="d-flex align-items-center justify-content-between gap-3 flex-wrap flex-md-nowrap">
                <h4 class="title fs-16px">
                    ...
                    {{ get_phrase('Purchase History course') }}
                </h4>
            </div>
        </div>
    </div>
    ...
    <div class="ol-card p-4">
        <div class="ol-card-body">
            <div class="row row-gap-3">
                ...
                @if (has_permission('admin.purchase.history.course.export'))
                ...
                @if (has_permission('admin.purchase.history.course.search'))
                    <div class="col-md-6">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($reports as $key => $report)
                                        @php
                                            ...
                                            $total_amount += $report->items->sum('amount');
                                        @endphp
                                        <tr>
                                            <th scope="row">
                                            ...
                                            <td class="print-d-none">
                                                @if (has_permission('admin.purchase.history.course.invoice'))
                                                    <div class="adminTable-action">
                                                        <a class="btn ol-btn-light ol-icon-btn" data-bs-toggle="tooltip" title="{{ get_phrase('Print') }}" href="{{ route('admin.purchase.history.invoice',['id'=>$report->id,'type'=>'course']) }}">
