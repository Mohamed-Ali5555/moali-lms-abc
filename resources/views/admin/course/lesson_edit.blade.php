...
<form class="ajaxFormSubmission" action="{{ route('admin.lesson.edit') }}" method="post" enctype="multipart/form-data">
    ...
    <div class="row mb-3">
        <div class="fpb7 col-sm-6 mb-3">
            ...
            <input class="form-control ol-form-control" step="1" type="datetime-local" name="start_time" value="{{ $lessons->start_time }}">
        </div>
        <div class="fpb7 col-sm-6 mb-3">
            <label class="form-label ol-form-label" for="title">
                {{ get_phrase('End Time') }}
            ...
            <input class="form-control ol-form-control"  step="1" type="datetime-local" name="end_time" value="{{ $lessons->end_time }}">
        </div>
    </div>
