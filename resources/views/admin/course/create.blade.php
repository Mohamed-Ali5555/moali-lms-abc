                            ...
                            <div class="col-md-6 pb-2">
                                <div class="eForm-layouts">
                                    ...
                                    {{-- <div class="fpb-7 mb-3">
                                        ...
                                        <textarea name="short_description"  placeholder="{{ get_phrase('Enter Short Description') }}" class="form-control ol-form-control" rows="5">{{old('short_description')}}</textarea>
                                    </div> --}}
                                    <div class="fpb-7 mb-3">
                                        <label class="form-label ol-form-label"
                                            for="description">{{ get_phrase('Description') }}</label>
                                        <textarea name="description" value="{{ old('description') }}" placeholder="{{ get_phrase('Enter Description') }}"
                                ...
                                <div class="eForm-layouts">
                                    ...
                                    {{-- <div class="fpb-7 mb-3">
                                        ...
                                        <select class="ol-select2" name="level" id="level" required>
                                            ...
                                            <option value="beginner"     {{ old('level') == 'beginner' ? 'selected' : '' }}>{{ get_phrase('Beginner') }}</option>
                                            <option value="intermediate" {{ old('level') == 'intermediate' ? 'selected' : '' }}>{{ get_phrase('Intermediate') }}</option>
                                            <option value="advanced"     {{ old('level') == 'advanced' ? 'selected' : '' }}>{{ get_phrase('Advanced') }}</option>
                                        </select>
                                    </div> --}}


                                    {{-- <div class="fpb-7 mb-3">
                                        <label for="language" class="form-label ol-form-label">
                                            {{ get_phrase('Made in') }} <span class="text-danger ms-1">*</span>
                                        </label>
                                        <select class="ol-select2" name="language" id="language" required>
                                            ...
                                            @foreach (App\Models\Language::get() as $language)
                                                <option value="{{ strtolower($language->name) }}"
                                                    ...
                                                    {{ old('language') == strtolower($language->name) ? 'selected' : '' }}>
                                                    {{ $language->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="fpb-7 mb-3">
                                        <label
                                            class="form-label ol-form-label col-sm-2 col-form-label">{{ get_phrase('Expiry period') }}</label>
                                        <div class="eRadios">
                                            <div class="form-check mr-2">
                                                ...
                                                <label class="form-check-label"
                                                    for="lifetime_expiry_period">{{ get_phrase('Lifetime') }}</label>
                                            </div>
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label"
                                                    for="limited_expiry_period">{{ get_phrase('Limited time') }}</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="fpb-7 mb-3" id="number_of_month" style="display: none">
                                        <label
                                            class="form-label ol-form-label col-sm-3 col-form-label">{{ get_phrase('Number of month') }}</label>

                                        <input class="form-control ol-form-control" type="number" name="number_of_month"
                                            value="{{ old('number_of_month') }}" min="1"
                                            placeholder="{{ get_phrase('After purchase, students can access the course until your selected month.') }}">
                                    </div>

                                    <div class="fpb-7 mb-3 ">
                                        <label for="enable_drip_content"
                                            class="form-label ol-form-label col-sm-4">{{ get_phrase('Enable drip content') }}
                                            <span class="text-danger ms-1">*</span></label>
                                        <div class="eRadios">
                                            <div class="form-check">
                                                <input type="radio" value="0" name="enable_drip_content"
                                                    class="form-check-input eRadioSuccess" id="drip_off" required
                                                    checked>
                                                <label for="drip_off"
                                                    class="form-check-label">{{ get_phrase('Off') }}</label>
                                            </div>

                                            <div class="form-check">
                                                <input type="radio" value="1" name="enable_drip_content"
                                                    class="form-check-input eRadioPrimary" id="drip_on" required>
                                                <label for="drip_on"
                                                    class="form-check-label">{{ get_phrase('On') }}</label>
                                            </div>
                                        </div>
                                    </div>
