...
<div class="paid-section" id="paid-section">
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
            <input type="number" name="price" class="form-control ol-form-control" id="price" min="1"
                step=".01" placeholder="{{ get_phrase('Enter your course price') }} ({{ currency() }})">
        </div>
    </div>
    ...
    <div class="row mb-3" id="discount_price_row" style="display: none;">
        ...
        <div class="col-sm-10">
            <input type="number" name="discount_price" class="form-control ol-form-control" id="discount_price"
                min="1" step=".01"
