                                        ...
                                        <tbody>
                                            @foreach ($courses as $key => $row)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="sub-title2 text-12px">
                                                            <a href="{{ route('admin.enroll.history', ['id' => $row->id]) }}"  data-bs-toggle="tooltip" title="{{ get_phrase('student enrollemt') }}"  class="edit-delete">
                                                                <p>
                                                                    <span class="btn btn-primary">  {{ course_enrollments($row->id) }}</span>
                                                                </p>
                                                            </a>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="sub-title2 text-12px">
                                                            ...
                                                            <a href="{{ route('admin.course.show_users',  $row->id) }}" data-bs-toggle="tooltip" title="{{ get_phrase('student not enrollemt') }}"  class="edit-delete">
                                                                <p>
                                                                    <span class="btn btn-primary">  {{ $users->count() }}
                                                                    </span>
                                                                </p>
                                                            </a>
