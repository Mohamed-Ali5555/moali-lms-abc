            ...
            <div class="row row-28 mb-110">
                @php
                    $top_courses = DB::table('courses')
                        ...
                        ->select('courses.id', 'courses.slug', 'courses.thumbnail', 'courses.title', 'courses.average_rating', 'courses.discount_flag', 'courses.is_paid', 'courses.price', 'courses.discount_price', DB::raw('COUNT(payment_histories.id) as total_sales'))
                        ->groupBy('courses.id', 'courses.slug', 'courses.thumbnail', 'courses.title', 'courses.average_rating', 'courses.discount_flag', 'courses.is_paid', 'courses.price', 'courses.discount_price')
                        ->where('status', 'active')
                                    ...
                                    <div class="date-time-price">
                                        <div>
                                            ...
                                            @if (isset($row->discount_flag) && $row->discount_flag == 1)
                                                <p class="value">{{ currency($row->price - $row->discount_price, 2) }}</p>
