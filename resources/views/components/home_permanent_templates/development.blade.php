...
@section('content')
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="development-banner-area">
                        ...
                        @endphp
                        <h1 class="title">{{ $phrase_one }}<span
                                class=" font-italic highlight">{{ $phrase_two }}</span></h1>
                        <a href="javascript:void(0);" class="video-play-btn" type="button" data-bs-toggle="modal"
                            data-bs-target="#promoVideo">
                            <span class="icon">
                        ...
                        <div class="hero-rated-profile-area">
                            <ul class="profiles d-flex align-items-center">
                                ...
                                @foreach ($students as $student)
                                    <li>
                                        <img data-bs-toggle="tooltip" title="{{ $student->name }}"
                                            src="{{ get_image($student->photo) }}" alt="">
                                    </li>
                                @endforeach
                                <li>
                                    <img src="{{ asset('assets/frontend/default/image/arrow-rotate-white-16.svg') }}"
                                        alt="">
                                </li>
                            </ul>
                            <p class="info">{{ count($total_students) }}+
                                {{ get_phrase('User already register and signing up for using it') }}</p>
                        </div>
    ...
    @if ($stordetails = json_decode(get_homepage_settings('development')))
        @php
        if (!function_exists('highlightLastWord')) {
                    ...
                    <div class="col-lg-6">
                        <div class="software-development-banner">
                            @if (isset($stordetails->image))
                                <img src="{{ asset('uploads/home_page_image/development/' . $stordetails->image) }}"
                                    alt="">
                            @else
                                <img src="{{ asset('assets/frontend/default/image/soft-dev-banner.webp') }}"
                                    alt="">
                            @endif
                        </div>
                    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="dev-section-title">
                        <h1 class="title mb-20">{{ get_phrase('Start Learning') }} <span
                                class="highlight">{{ get_phrase('Coding') }}</span> {{ get_phrase('Languages') }}</h1>
                        <p class="info">
            ...
            <div class="row row-20 mb-100 justify-content-center">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="learning-coding-card pt-3">
                        <div class="banner mb-5">
                            <img src="{{ asset('assets/frontend/default/image/learnig-coding-banner1.webp') }}"
                                alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="learning-coding-card pt-3">
                        <div class="banner mb-5">
                            <img src="{{ asset('assets/frontend/default/image/learnig-coding-banner2.webp') }}"
                                alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="learning-coding-card pt-3">
                        <div class="banner mb-5">
                            <img src="{{ asset('assets/frontend/default/image/learnig-coding-banner3.webp') }}"
                                alt="">
                        </div>
    ...
    <section>
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="dev-section-title">
                        <h1 class="title mb-20">{{ get_phrase('Pick A Course To') }} <span
                                class="highlight">{{ get_phrase('Get Started') }}</span></h1>
                        <p class="info">
                            {{ get_phrase("The industry's standard dummy text ever since the  unknown printer took a galley of type and scrambled") }}
                        </p>
                    </div>
                                ...
                                <div class="dev-course-card-body">
                                            ...
                                            <div class="ratings d-flex align-items-center">
                                                @for ($i = 0; $i < 5; $i++)
                                                    ...
                                                    @elseif ($i == $full_stars && $has_half_star)
                                                        <img src="{{ asset('assets/frontend/default/image/star-yellow-half-14.svg') }}"
                                                            alt="Half Star">
                                                    @else
                                    ...
                                    <div class="leason-student d-flex align-items-center">
                                        <div class="leasons-students d-flex align-items-center">
                                            ...
                                            <p class="total fw-500">
                                                {{ lesson_count($row->id) }}{{ get_phrase('lessons') }}</p>
                                        </div>
                                        <div class="leasons-students d-flex align-items-center">
                                            <i class="fi-rr-users"></i>
                                            <p class="total fw-500">{{ course_enrollments($row->id) }}
                                                {{ get_phrase('Students') }}</p>
                                        </div>
                                    </div>


                                    @if(auth()->check() && \App\Models\Enrollments::where('user_id',auth()->user()->id)->where('course_id',$row->id)->exists())
                                        <div class="bg-primary">انت مشترك في هذا الكورس</div>
                                    @else
                                        <div class="bg-primary">يمكنك الاشتراك هنااااااا</div>
    ...
    <section>
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="dev-section-title">
                        <h1 class="title mb-20">{{ get_phrase('Pick A book To') }} <span
                                class="highlight">{{ get_phrase('Get Started') }}</span></h1>
                        <p class="info">
                            {{ get_phrase("The industry's standard dummy text ever since the  unknown printer took a galley of type and scrambled") }}
                        </p>
            ...
            <div class="row row-20 mb-110">
                @php
                    $books = DB::table('books')->where('status', '1')->latest('id')->get();
                @endphp
                @foreach ($books->take(4) as $key => $row)
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        <a href="{{ route('book.details', $row->slug) }}" class="dev-course-card-link">
                            <div class="dev-course-card">
                                <div class="banner">
                                    <img src="{{ get_image($row->thumbnail) }}" alt="banner">
                                </div>
                                ...
                                <div class="dev-course-card-body">
                                    ...
                                    <div class="leason-student d-flex align-items-center">
                                        ...
                                        <div class="leasons-students d-flex align-items-center">
                                            <i class="fi-rr-users"></i>
                                            <p class="total fw-500">books student count
                                                {{ get_phrase('Students') }}</p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-12">
                        <div class="programming-ebook-area d-flex align-items-center justify-content-between">
                            <div class="programming-ebook-banner">
                                <img src="{{ asset('assets/frontend/default/image/programming-ebook-banner.webp') }}"
                                    alt="">
                            </div>
                            <div class="programming-ebook-details">
                                <h2 class="title">{{ get_phrase('Download our mobile app, start learning') }} <span
                                        class="highlight">{{ get_phrase('Academy') }}</span></h2>
                                <p class="info mb-30">
                                    {{ get_phrase("The industry's standard dummy text ever since the  unknown printer took a galley of type and scrambled") }}
                                </p>
    ...
    <section>
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="dev-section-title">
                        <h1 class="title">{{ get_phrase('Frequently Asked') }} <span
                                class="highlight">{{ get_phrase('Questions') }}</span></h1>
                    </div>
                </div>
            </div>
            <!-- QNA Accordion -->
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="{{ $key }}">
                                    <button class="accordion-button {{ $key == 0 ? '' : 'collapsed' }}" type="button"
                                        data-bs-toggle="collapse" data-bs-target="#qnaOne{{ $key }}"
                                        aria-expanded="true" aria-controls="qnaOne">
                                        {{ $faq['question'] }}
                                    </button>
                                </h2>
                                <div id="qnaOne{{ $key }}"
                                    class="accordion-collapse collapse px-0  {{ $key == 0 ? 'show' : '' }}"
                                    data-bs-parent="#accordionExample4" aria-labelledby="{{ $key }}">
    ...
    <section>
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="dev-section-title">
                        <h1 class="title mb-20">{{ get_phrase('What Our') }} <span
                                class="highlight">{{ get_phrase('Students') }}</span> {{ get_phrase('Have To Say') }}
                        </h1>
                        <p class="info">
                            {{ get_phrase("The industry's standard dummy text ever since the  unknown printer took a galley of type and scrambled") }}
                        </p>
                ...
                <div class="modal-body bg-dark">
                    ...
                    @if (get_frontend_settings('promo_video_provider') == 'youtube')
                        <div class="plyr__video-embed" id="promoPlayer">
                            <iframe height="500"
                                src="{{ get_frontend_settings('promo_video_link') }}?origin=https://plyr.io&amp;iv_load_policy=3&amp;modestbranding=1&amp;playsinline=1&amp;showinfo=0&amp;rel=0&amp;enablejsapi=1"
                                allowfullscreen allowtransparency allow="autoplay"></iframe>
                        </div>
                    @elseif (get_frontend_settings('promo_video_provider') == 'vimeo')
                        <div class="plyr__video-embed" id="promoPlayer">
                            <iframe height="500" id="promoPlayer"
                                src="https://player.vimeo.com/video/{{ get_frontend_settings('promo_video_link') }}?loop=false&amp;byline=false&amp;portrait=false&amp;title=false&amp;speed=true&amp;transparent=0&amp;gesture=media"
                                allowfullscreen allowtransparency allow="autoplay"></iframe>
                        </div>
                    @else
