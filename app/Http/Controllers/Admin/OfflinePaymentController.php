        ...
        if ($payment_details->item_type == 'course') {
            ...
            foreach ($items as $item) {
                ...
                if ($payment_details->item_type == 'course') {
                    ...
                    $payment['amount']    = $course->discount_flag == 1 ? $course->discount_price : $course->price;
            ...
            foreach($bootcamps as $bootcamp){
                ...
                $bootcamp_payment['price']          = $bootcamp->discount_flag == 1 ? $bootcamp->price - $bootcamp->discount_price : $bootcamp->price;
