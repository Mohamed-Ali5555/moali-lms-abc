...
Route::name('admin.')->prefix('admin')->middleware('admin')->group(function () {
    ...
    Route::controller(UsersController::class)->group(function () {
        ...
        Route::post('student/move', 'student_move')->name('student.move');
    ...
    Route::controller(SettingController::class)->group(function () {
        ...
        Route::get('theme_settings', 'theme_settings')->name('theme.settings');
        Route::any('theme_settings/store/{param1}/{id?}', 'theme_settings_store')->name('theme.settings.store');
